    ...
    internal sealed class CheckoutService : StatefulService, ICheckoutService
    {
        ...
        public async Task<CheckoutSummary> CheckoutAsync(string userId)
        {
            ...
            foreach (var basketItem in basket)
            {
                ...
                var checkProduct = new CheckoutProduct
                {
                    Product = product,
                    Price = product.Price,
                    Quantity = basketItem.Quantity
                };
                result.Products.Add(checkProduct);
            }
        ...
        {
            return ActorProxy.Create<IUserActor>(new ActorId(userId), new Uri("fabric:/ECommerce/UserActorSevices"));
        }
