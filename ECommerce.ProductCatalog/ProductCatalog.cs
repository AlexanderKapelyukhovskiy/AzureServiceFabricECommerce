...
namespace ECommerce.ProductCatalog
{
    ...
    internal sealed class ProductCatalog : StatefulService, IProductCatalogService
    {
        ...
        {
            await _repo.AddProducts(product);
        }
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            var product2 = new Product
            {
                Id = Guid.NewGuid(),
                Name = "Surface Book",
                Description = "Microdoft's Latest Laptop, i7 CPU 1Tb SSD",
                Price = 2200,
                Availability = 15
            };
            ...
            var product3 = new Product
            {
                ...
                Description = "Computer Mouse, bluetooth, requires 2 AAA battaries",
                Price = 60,
                Availability = 30
            };

            //await _repo.AddProducts(product1);
            //await _repo.AddProducts(product2);
            //await _repo.AddProducts(product3);
